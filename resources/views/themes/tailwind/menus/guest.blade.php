<nav class="flex items-center justify-end flex-1 hidden w-full h-full space-x-10 md:flex">
    ...
    <a href="{{ route('login') }}" class="text-base font-medium leading-6 text-gray-500 whitespace-no-wrap hover:text-wave-600 focus:outline-none focus:text-gray-900 text-white">
        Ingresar
    </a>

...
<div class="container">
    ...
    <div class="col-md-3"> <!-- Cambiado a col-md-12 para usar todo el ancho -->
    <div class="btn-group" role="group" aria-label="Basic example">
            @foreach ($arbol as $ab)
            <button type="button" class="btn  text-light">
            <li class="list-group-item text-center" style="flex: 1 0 30%; margin: 5px; background-color: #00000000;" > <!-- Añadido estilo flex -->

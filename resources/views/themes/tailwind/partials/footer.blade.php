            ...
            <ul class="flex items-center mt-10 space-x-5 lg:mt-0">
                ...
                <li>
                    <a href="#" class="text-gray-600 hover:text-gray-900">
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M9 3v12a4 4 0 1 0 4-4h3V7h-2a5 5 0 0 1-5-4z" />
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="#" class="text-gray-600 hover:text-gray-900">
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path
                                d="M10 15l5.19-3L10 9v6zm12-3c0-1.66-.2-3.22-.58-4.64-.19-.72-.7-1.2-1.44-1.44C19.22 5 17.66 4.8 16 4.8H8c-1.66 0-3.22.2-4.64.58-.72.19-1.2.7-1.44 1.44C1.8 7.78 1.6 9.34 1.6 11v2c0 1.66.2 3.22.58 4.64.19.72.7 1.2 1.44 1.44C4.78 19 6.34 19.2 8 19.2h8c1.66 0 3.22-.2 4.64-.58.72-.19 1.2-.7 1.44-1.44.38-1.42.58-2.98.58-4.64v-2z" />
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="#" class="text-gray-600 hover:text-gray-900">
                        ...
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M22 3L2 12l5 2 2 5 3-7 7-3-2-5zM7.5 12.5l4.5 4.5-2.5-6-6-2 4 3z" />
                        </svg>
                    </a>
                </li>
            </ul>

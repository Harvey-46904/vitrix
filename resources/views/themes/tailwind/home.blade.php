...
@section('content')
        ...
        <div class="relative z-20 px-8 mx-auto xl:px-5 max-w-7xl">
            ...
            <div class="flex flex-col items-center h-full pt-16 pb-56 lg:flex-row">
                ...
                <div class="flex flex-col items-start w-full mb-16 md:items-center lg:pr-12 lg:items-start lg:w-1/2 lg:mb-0">
                    ...
                    <p class=" text-white invisible max-w-2xl mt-0 text-base text-left text-gray-600 transition-none duration-700 ease-out delay-300 transform translate-y-12 opacity-0 md:text-center lg:text-left sm:mt-2 md:mt-0 sm:text-base lg:text-lg xl:text-xl" data-replace='{ "transition-none": "transition-all", "invisible": "visible", "translate-y-12": "translate-y-0", "scale-110": "scale-100", "opacity-0": "opacity-100" }'>{{ theme('home_description') }}</p>
    ...
    <div class="container-fluid">
        ...
        <div class="section section-b text-white">
            Vectores de juegos alusión casino y 
            juegos
        </div>
